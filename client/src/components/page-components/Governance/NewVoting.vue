  ...
  <div>
    ...
    <b-form @submit.prevent="submit">
      <b-select
        ...
        required
      >
        <option slot="first" :value="null" disabled>
...
const tradingOptions = [
  ...
  {
    value: "NUMBER_OF_SIMULTANEOUS_TRANSACTIONS",
    text: "Number of simultaneous transactions"
  }
];

const governanceOptions = [
  {
    value: "DEPOSIT_AMOUNT_TO_CREATE_VOTE",
    text: "Deposit amount to create vote"
  },
  ...
  {
    value: "MIN_TURNOUT_NUMBER_OF_VOTERS",
    text: "Minimum turnout number of voters"
  },
  {
    value: "MIN_SUPERIORITY_FOR_DECISION",
    text: "Minimum superiority for decision"
  },
  { value: "MIN_FUNDING_AMOUNT", text: "Minimum funding amount" },
  { value: "MAX_FUNDING_AMOUNT", text: "Maximum funding amount" },
  {
    value: "DIVIDEND_DISTRIBUTION_SCHEME",
    text: "Dividend distribution scheme"
  },
...
const numberValues = ["commission", "amount"];
...
export default {
  ...
  computed: {
    ...
    votingTypeId() {
      return (
        VOTING_TYPE[this.votingType]?.[this.assetType]?.[this.optionSelected] ||
  ...
  watch: {
    votingType(val) {
      this.assetOptions =
        val === "OTHER" ? assetOptionsOther : assetOptionsUpload;
      this.assetType = null;
    },
    assetType(val) {
      this.optionOptions =
        val === "TRADING_OPTIONS" ? tradingOptions : governanceOptions;
