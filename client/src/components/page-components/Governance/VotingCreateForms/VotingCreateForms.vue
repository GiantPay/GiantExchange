<template>
  <div>
    ...
    <BrokerRegistration v-if="votingTypeId === VOTING_TYPE.UPLOAD.FACTORY_BROKERS" />
    ...
    <FundingInitiative v-if="votingTypeId === VOTING_TYPE.OTHER.FUNDING_INITIATIVE" />
...
export default {
  ...
  computed: {
    betweenNewValues() {
      return this.votingTypeId >= VOTING_TYPE.OTHER.TRADING_OPTIONS.MAX_ORACLES_IN_ASSET
        && this.votingTypeId <= VOTING_TYPE.OTHER.GOVERNANCE_OPTIONS.MASTERNODE_MULTIPLIER;
    },
  },
};
</script>
