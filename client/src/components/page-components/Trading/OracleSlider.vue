  ...
  <div class="oracle-list mt-2">
    <swiper ref="mySwiper" :options="swiperOption">
      <swiper-slide
        ...
        :key="oracle.title"
        class="oracle bg-gray-lighter"
        :class="{ active: oracle.isActive }"
      >
        <div @click="chooseOracle(index)">
          <div class="font-w700">
            <a
              href="#"
              @click.prevent.stop="
                showPopup({ _id: oracle.id }, POPUP_TYPE.ORACLE)
              "
            >
              Oracle "{{ oracle.title }}"
            </a>
          </div>
          <div v-if="!oracle.isActive" class="oracle-info">
            <div class="font-w700">
              {{ oracle.volume.BTC }} BTC
              <div class="font-s12 font-w400">
                24hr Volume
              </div>
            </div>
            <div class="font-w700">
